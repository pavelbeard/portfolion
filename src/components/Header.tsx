...
const Header = () => {
  ...
  return (
    ...
    >
      {isDesktop ? (
        <nav className="relative nav-header px-8 py-4 flex items-center gap-x-4 text-slate-900 dark:text-slate-300">
          <Link className="hover:text-slate-500 hover:dark:text-slate-300" to="/#experience">{t("HEADER.EXPERIENCE")}</Link>
          <Link className="hover:text-slate-500 hover:dark:text-slate-300" to="/#projects">{t("HEADER.PROJECTS")}</Link>
          <Link className="hover:text-slate-500 hover:dark:text-slate-300" to="/#tech-stack">{t("HEADER.TECH_STACK")}</Link>
          <Link className="hover:text-slate-500 hover:dark:text-slate-300" to="/#about-me">{t("HEADER.ABOUT_ME")}</Link>
          <Link className="hover:text-slate-500 hover:dark:text-slate-300" to="/#contacts">{t("HEADER.CONTACTS")}</Link>
          <ChangeLangBtn />
          <ColorModeBtn />
        </nav>
      ) : isBurgerOpen ? (
        <nav className="flex flex-col gap-y-4 text-slate-900 dark:text-slate-300">
          ...
          >
            ...
            <Link className="px-4 py-2 hover:bg-slate-300 hover:dark:bg-slate-500" to="/#tech-stack">{t("HEADER.TECH_STACK")}</Link>
            <Link
              className="px-4 py-2 hover:bg-slate-300 hover:dark:bg-slate-500"
              to="/#about-me"
            >
